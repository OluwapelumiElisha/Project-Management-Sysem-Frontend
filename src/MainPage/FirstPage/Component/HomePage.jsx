...
if (isloading) {
 return(
//   <div className="flex items-center justify-center min-h-screen bg-white -mt-10">
//   <div className="text-center">
//     <div className="flex justify-center mb-4">
//       <div className="w-16 h-16 border-t-4 border-b-4 border-red-600 rounded-full animate-spin"></div>
//     </div>
//     <h2 className="text-xl font-semibold text-gray-700">Loading Projects...</h2>
...
<div className="text-center">
  <div className="flex justify-center mb-4">
    <div className="w-16 h-16 bg-red-500 rounded-full flex items-center justify-center animate-bounce"><svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white" viewBox="0 0 20 20" fill="currentColor"
      ><path  fillRule="evenodd"  d="M11.3 1.046a1 1 0 00-1.8 0L5.433 10H2a1 1 0 000 2h4.07l-2.588 7.963a1 1 0 001.8.774L14.567 12H18a1 1 0 000-2h-4.07l2.588-7.963a1 1 0 00-1.8-.774L11.3 1.046z" clipRule="evenodd" />
      </svg>
    </div>
  </div>
  <h2 className="text-xl font-semibold text-gray-700">Loading Projects...</h2>
                    ...
                    return (
                      ...
                      >
                        <div className="flex justify-between items-center">
                          <h2 className="font-semibold">{project?.name?.slice(0,20)}</h2>
