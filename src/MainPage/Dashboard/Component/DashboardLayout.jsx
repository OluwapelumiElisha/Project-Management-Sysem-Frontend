...
//       {/* Sidebar */}
//       <div
//         className={`fixed inset-y-0 left-0 bg-white shadow-2xl lg:block md:block lg:w-[20%] w-[15%] p-4 overflow-y-auto transition-transform transform ${
//           isToggle ? 'translate-x-0' : '-translate-x-full'
//         } lg:translate-x-0`}
//       >
//         <div className="flex flex-col h-full">
//           <div className="mt-2 flex-grow space-y-36">
//             <ul className="lg:space-y-6 md:space-y-5 sm:space-y-1 space-y-0">
//               {useFirstList.map((items, i) => (
//                 <li
//                   key={i}
//                   className="block py-2 px-4 text-black sm:text-xs text-xs lg:text-base font-sans rounded md:bg-transparent md:p-0 dark:text-white md:dark:text-blue-500 text-black"
//                 >
//                   <NavLink
...
//                       <img
//                         src={items.sideicon}
//                         className="w-[20px] lg:w-5 lg:h-4 md:w-4 md:h-4 sm:w-5 sm:h-5"
//                         alt=""
//                       />
...
//                 <li
//                   key={i}
//                   className="block py-2 px-4 text-black sm:text-xs text-xs lg:text-base font-sans rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500"
//                 >
//                   <NavLink
//                     className={({ isActive, isPending }) =>
//                       isPending ? 'pending' : isActive ? 'text-black' : ''
...
//                       <img
//                         src={items.sideicon}
//                         className="w-[20px] lg:w-5 lg:h-6 md:w-4 md:h-4 sm:w-5 sm:h-5"
//                         alt=""
//                       />
//                       <div className="lg:block md:block sm:hidden hidden">{items.name}</div>
//                     </div>
...
//               className="lg:hidden md:hidden mb-4 ml-auto w-6 h-6"
//               alt="Close"
//             />
//           )}
//         </div>
...
//         <header className="z-10 bg-white shadow-md p-1 flex justify-between items-center fixed top-0 left-0 right-0">
//           <div className="flex lg:ms-6 md:ms-6 ms-1 items-center lg:space-x-5 md:space-x-5 sm:space-x-3 space-x-1">
//             <img src={logo} alt="PMS Logo" className="h-8 w-8" />
//             <span className="font-semibold lg:text-xl md:text-sm text-sm">Projectify</span>
//           </div>
